 ...
 */
final class Version20190527030552 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE customer ADD username VARCHAR(180) NOT NULL, ADD roles JSON DEFAULT NULL, ADD password VARCHAR(255) NOT NULL, ADD firstname VARCHAR(255) NOT NULL, ADD lastname VARCHAR(255) NOT NULL, ADD email VARCHAR(255) NOT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL');
        ...
        $this->addSql('ALTER TABLE vehicle_owner ADD username VARCHAR(180) NOT NULL, ADD roles JSON DEFAULT NULL, ADD password VARCHAR(255) NOT NULL, ADD firstname VARCHAR(255) NOT NULL, ADD lastname VARCHAR(255) NOT NULL, ADD email VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE customer DROP username, DROP roles, DROP password, DROP firstname, DROP lastname, DROP email, CHANGE id id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE vehicle_owner DROP username, DROP roles, DROP password, DROP firstname, DROP lastname, DROP email');
    }
}
