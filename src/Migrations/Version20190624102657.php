 ...
 */
final class Version20190624102657 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE alert (id INT AUTO_INCREMENT NOT NULL, comment VARCHAR(30) NOT NULL, AlertType_id INT DEFAULT NULL, User_id INT DEFAULT NULL, Line_id INT DEFAULT NULL, INDEX IDX_17FD46C1DCC1E873 (AlertType_id), INDEX IDX_17FD46C168D3EA09 (User_id), INDEX IDX_17FD46C182C64CDE (Line_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE position (id INT AUTO_INCREMENT NOT NULL, vehicle_id INT DEFAULT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, INDEX IDX_462CE4F5545317D1 (vehicle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE station (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(30) NOT NULL, Position_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_9F39F8B15B18A191 (Position_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, nbr_bus INT NOT NULL, mark VARCHAR(30) NOT NULL, on_station INT NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, VehicleOwner_id INT DEFAULT NULL, VehicleType_id INT DEFAULT NULL, INDEX IDX_1B80E48664B48123 (VehicleOwner_id), INDEX IDX_1B80E48697782B87 (VehicleType_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE interstation (id INT AUTO_INCREMENT NOT NULL, periode VARCHAR(255) NOT NULL, time TIME NOT NULL, distance DOUBLE PRECISION NOT NULL, one_Station INT DEFAULT NULL, other_Station INT DEFAULT NULL, INDEX IDX_C9FA7DE3309FDC03 (one_Station), INDEX IDX_C9FA7DE343D95F41 (other_Station), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE line_station (id INT AUTO_INCREMENT NOT NULL, station_id INT DEFAULT NULL, line_id INT DEFAULT NULL, rank INT NOT NULL, stopduration INT NOT NULL, INDEX IDX_2A9D79D621BDB235 (station_id), INDEX IDX_2A9D79D64D7B7542 (line_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vehicle_owner (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_ADCF6690F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user ADD username VARCHAR(180) NOT NULL, ADD password VARCHAR(255) NOT NULL, ADD email VARCHAR(255) NOT NULL, CHANGE firstname firstname VARCHAR(255) NOT NULL, CHANGE lastname lastname VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP username, DROP password, DROP email, CHANGE firstname firstname VARCHAR(50) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE lastname lastname VARCHAR(50) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
